...
Last merged slice: **a bar with nothing to say** (2026-09-22) — the launch
...
1. **Archive the fifty-three OpenSpec changes.** Folding their requirements
...
4. **`just smoke`.** The Mac2 driver host dies at session creation; every
   ...
   been ruled out, and by which command, is under "Known broken". Forty-three
...
- **The Mac2 driver cannot enable automation mode** (2026-09-22; the cause is
  ...
  **What to try, in order:**
  ...
  Forty-three changes carry an unchecked "smoke green" task waiting on this.
