...
| P2 | **Task 9d: OK-standard track name validation** | pending | [smoke-ok-standard.md](smoke-ok-standard.md) | Verify track name validation for YYYYMMDD_Callsign format (per LizaAlert OK standard). Non-conforming name triggers ⚠️ icon or warning message; warning disappears on valid name. Success: validation visible and works; format specified in warning. |
