...
# Run the desktop smoke journeys. `just smoke cj3` runs one of them.
smoke filter="":
    ...
    cargo test --manifest-path tools/ozi-rs-mcp/Cargo.toml --test smoke_core_workflow {{filter}} -- --ignored --nocapture --test-threads=1
