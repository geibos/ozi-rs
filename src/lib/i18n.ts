...
const dictionaries = {
  en: {
    ...
    "tracksTab.exportAllTitle": "Every track in the project, in one GPX file",
    "tracksTab.exportAllDone": "Exported {count} tracks",
    "tracksTab.exportAllFailed": "Failed to export the tracks",
  ...
  ru: {
    ...
    "tracksTab.exportAllTitle": "Все треки проекта в один GPX-файл",
    "tracksTab.exportAllDone": "Выгружено треков: {count}",
    "tracksTab.exportAllFailed": "Не удалось выгрузить треки",
