...
const dictionaries = {
  en: {
    ...
    "report.noteSave": "Save",
    "report.noteFailed": "Could not add the description",
    "report.failed": "Could not save the moment",
    "palette.saveReport": "Save this moment for a report",
    "palette.revealReports": "Show the reports folder",
    "export.reveal": "Show",
    "export.revealFailed": "Could not show the file",
    ...
    "shell.mode": "Mode",
    "shell.modeView": "View",
    "mode.drawNeedsLayer": "Choose a track layer to draw into first",
    "shell.modeDraw": "Draw",
    "shell.modeEdit": "Edit",
    ...
    "calibrate.title": "Map name",
    "calibrate.topLeft": "Top-left corner",
    "calibrate.bottomRight": "Bottom-right corner",
    "calibrate.formats":
      "60.05, 30.20 · 60°03'00\"N 30°12'00\"E · N 60 03.0 E 30 12.0",
    "calibrate.go": "Calibrate and open",
    "calibrate.working": "Calibrating…",
    "calibrate.done": "{file} written",
    "calibrate.failed": "Could not calibrate the picture",
    "calibrate.sizeFailed": "Could not read the picture's size",
  ...
  ru: {
    ...
    "report.noteSave": "Сохранить",
    "report.noteFailed": "Не удалось добавить описание",
    "report.failed": "Не удалось сохранить момент",
    "palette.saveReport": "Сохранить момент для отчёта",
    "palette.revealReports": "Показать папку отчётов",
    "export.reveal": "Показать",
    "export.revealFailed": "Не удалось показать файл",
    ...
    "mode.drawNeedsLayer": "Сначала выберите слой, в который рисовать",
    ...
    "calibrate.title": "Название карты",
    "calibrate.topLeft": "Левый верхний угол",
    "calibrate.bottomRight": "Правый нижний угол",
    "calibrate.formats":
      "60.05, 30.20 · 60°03'00\"N 30°12'00\"E · С 60 03.0 В 30 12.0",
    "calibrate.go": "Привязать и открыть",
    "calibrate.working": "Привязываю…",
    "calibrate.done": "{file} записан",
    "calibrate.failed": "Не удалось привязать картинку",
    "calibrate.sizeFailed": "Не удалось прочитать размер картинки",
